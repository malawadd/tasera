...
import "./interfaces/IUniswapV3Tasera.sol";
import "@uniswap/v3-core/contracts/interfaces/IUniswapV3Pool.sol";
import "@uniswap/v3-core/contracts/interfaces/pool/IUniswapV3PoolImmutables.sol";

import "hardhat/console.sol";

contract UniswapV3Tasera is IUniswapV3Tasera {
        ...
        returns (PoolState memory poolState)
    {
        ...
        (uint160 sqrtPriceX96, int24 tick, , , , , bool unlocked) = pool
            .slot0(); // external call
        ...
        )
    {
        ...
        state = SwapState({
            ...
            liquidity: 0 // nodified after initialization
        });
    }
        ...
        )
    {
        ...
        if (finalSqrtPriceX96 == sqrtPriceNextX96) {
            if (step.initialized) {
                ...
                finalLiquidity = LiquidityMath.addDelta(
                    firstLiquidity,
                    liquidityNet
                );
            }
